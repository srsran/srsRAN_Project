...
void test_eutra_nr_capabilities()
{
...
void test_ue_rrc_reconfiguration()
{
...
int main()
{
  ...
  test_eutra_nr_capabilities();
  test_ue_mrdc_capabilities();
  test_ue_rrc_reconfiguration();
  test_radio_bearer_config();
  test_cell_group_config();
