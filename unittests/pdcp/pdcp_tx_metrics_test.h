...
class pdcp_tx_metrics_test_frame : public pdcp_tx_lower_notifier, public pdcp_tx_upper_control_notifier
{
public:
...
class pdcp_tx_metrics_test : public ::testing::Test, public ::testing::WithParamInterface<pdcp_sn_size>
{
protected:
  void SetUp() override
  {
  ...
  pdcp_tx_metrics_test_frame  test_frame = {};
