...
e1_message generate_cu_cp_e1_setup_failure(unsigned transaction_id);
...
/// \return The CU-CP E1 Setup Failure.
e1_message generate_cu_cp_e1_setup_failure_with_time_to_wait(unsigned                   transaction_id,
...
e1_message generate_bearer_context_setup_response(gnb_cu_cp_ue_e1ap_id_t cu_cp_ue_e1ap_id,
...
e1_message generate_bearer_context_setup_failure(gnb_cu_cp_ue_e1ap_id_t cu_cp_ue_e1ap_id,
                                                 gnb_cu_up_ue_e1ap_id_t cu_up_ue_e1ap_id);
...
e1_message generate_bearer_context_modification_response(gnb_cu_cp_ue_e1ap_id_t cu_cp_ue_e1ap_id,
                                                         gnb_cu_up_ue_e1ap_id_t cu_up_ue_e1ap_id);
...
e1_message generate_bearer_context_modification_failure(gnb_cu_cp_ue_e1ap_id_t cu_cp_ue_e1ap_id,
                                                        gnb_cu_up_ue_e1ap_id_t cu_up_ue_e1ap_id);
...
e1_message generate_bearer_context_release_complete(gnb_cu_cp_ue_e1ap_id_t cu_cp_ue_e1ap_id,
                                                    gnb_cu_up_ue_e1ap_id_t cu_up_ue_e1ap_id);
