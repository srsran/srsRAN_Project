...
TEST_F(e1ap_cu_cp_test, when_cu_cp_e1_setup_response_received_then_cu_cp_connected)
{
  ...
  ASSERT_EQ(e1_pdu_notifier.last_e1_msg.pdu.type().value, asn1::e1ap::e1ap_pdu_c::types_opts::init_msg);
  ...
  unsigned   transaction_id    = get_transaction_id(e1_pdu_notifier.last_e1_msg.pdu).value();
...
TEST_F(e1ap_cu_cp_test, when_cu_cp_e1_setup_failure_with_time_to_wait_received_then_retry_with_success)
{
  ...
  for (unsigned msec_elapsed = 0; msec_elapsed < 10000; ++msec_elapsed) {
    ASSERT_FALSE(t.ready());
    ASSERT_EQ(e1_pdu_notifier.last_e1_msg.pdu.type().value, asn1::e1ap::e1ap_pdu_c::types_opts::nulltype);
  ...
  unsigned transaction_id2 = get_transaction_id(e1_pdu_notifier.last_e1_msg.pdu).value();
...
TEST_F(e1ap_cu_cp_test, when_received_cu_up_e1_setup_request_valid_then_connect_cu_up)
{
  ...
  ASSERT_EQ(cu_up_processor_notifier.last_cu_up_e1_setup_request.request->gnb_cu_up_name.value.to_string(), "srsCU-UP");
  ...
  ASSERT_EQ(asn1::e1ap::e1ap_pdu_c::types_opts::options::successful_outcome, e1_pdu_notifier.last_e1_msg.pdu.type());
  ASSERT_EQ(asn1::e1ap::e1ap_elem_procs_o::successful_outcome_c::types_opts::options::gnb_cu_up_e1_setup_resp,
            e1_pdu_notifier.last_e1_msg.pdu.successful_outcome().value.type());
}
...
TEST_F(e1ap_cu_cp_test, when_received_cu_up_e1_setup_request_invalid_then_reject_cu_up)
{
  ...
  ASSERT_EQ(asn1::e1ap::e1ap_pdu_c::types_opts::options::unsuccessful_outcome, e1_pdu_notifier.last_e1_msg.pdu.type());
  ASSERT_EQ(asn1::e1ap::e1ap_elem_procs_o::unsuccessful_outcome_c::types_opts::gnb_cu_up_e1_setup_fail,
            e1_pdu_notifier.last_e1_msg.pdu.unsuccessful_outcome().value.type());
}
