...
TEST_F(cu_up_test, ul_data_flow)
{
  ...
  const uint8_t t_pdu_arr1[] = {
      0x80, 0x00, 0x45, 0x00, 0x00, 0x54, 0xe8, 0x83, 0x40, 0x00, 0x40, 0x01, 0xfa, 0x00, 0xac, 0x10, 0x00, 0x03,
      0xac, 0x10, 0x00, 0x01, 0x08, 0x00, 0x2c, 0xbe, 0xb4, 0xa4, 0x00, 0x01, 0xd3, 0x45, 0x61, 0x63, 0x00, 0x00,
      0x00, 0x00, 0x1a, 0x20, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
  ...
  const uint8_t t_pdu_arr2[] = {
      0x80, 0x01, 0x45, 0x00, 0x00, 0x54, 0xe8, 0x83, 0x40, 0x00, 0x40, 0x01, 0xfa, 0x00, 0xac, 0x10, 0x00, 0x03,
      0xac, 0x10, 0x00, 0x01, 0x08, 0x00, 0x2c, 0xbe, 0xb4, 0xa4, 0x00, 0x01, 0xd3, 0x45, 0x61, 0x63, 0x00, 0x00,
      0x00, 0x00, 0x1a, 0x20, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
      0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29,
      0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37};
  ...
  ASSERT_EQ(ret, 92);
  EXPECT_TRUE(std::equal(t_pdu_span1.begin() + 2, t_pdu_span1.end(), rx_buf.begin() + 8));

  // receive message 2
  ret = recv(sock_fd, rx_buf.data(), rx_buf.size(), 0);
  ASSERT_EQ(ret, 92);
  EXPECT_TRUE(std::equal(t_pdu_span2.begin() + 2, t_pdu_span2.end(), rx_buf.begin() + 8));
