...
void test_pusch_resource_allocation()
{
  ...
  TESTASSERT(res_grid_alloc[0].ul_res_grid.sch_crbs(bwp_cfg).none());
  ...
  TESTASSERT(res_grid_alloc[0].ul_res_grid.sch_crbs(bwp_cfg).any());
  TESTASSERT_EQ(res_grid_alloc[0].ul_res_grid.sch_crbs(bwp_cfg).count(), ul_grant.prbs.length());
  ...
  TESTASSERT(res_grid_alloc[1].ul_res_grid.sch_crbs(bwp_cfg).any());
  TESTASSERT_EQ(res_grid_alloc[1].ul_res_grid.sch_crbs(bwp_cfg).count(), ul_grant2.prbs.length());
  ...
  TESTASSERT_EQ(res_grid_alloc[0].ul_res_grid.sch_crbs(bwp_cfg).count(), ul_grant2.prbs.length());
}
