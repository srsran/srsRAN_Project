...
static const std::vector<prbs_calculator_test_entry> prbs_calculator_test_table = {
    // clang-format off
  {{39, 12, 36, 0, 2, 0.37012, 1, 0}, 4U, 40U},
  {{41, 12, 36, 0, 2, 0.37012, 1, 0}, 5U, 51U},
  {{53, 12, 36, 0, 2, 0.37012, 1, 0}, 6U, 60U},
  {{53, 12, 36, 0, 4, 0.60156, 1, 0}, 2U, 66U},
  {{54, 12, 36, 0, 4, 0.60156, 1, 0}, 2U, 66U},
  {{75, 12, 36, 0, 4, 0.60156, 1, 0}, 3U, 101},
  {{102, 12, 36, 0, 4, 0.60156, 1, 0}, 4U, 129U},
  {{133, 12, 36, 0, 6, 0.70215, 1, 0}, 3U, 177U},
  {{172, 12, 36, 0, 6, 0.70215, 1, 0}, 3U, 177U},
  {{209, 12, 36, 0, 6, 0.70215, 1, 0}, 4U, 233U},
  {{241, 12, 36, 0, 6, 0.70215, 1, 0}, 5U, 285U},
  {{275, 12, 36, 0, 6, 0.70215, 1, 0}, 5U, 285U},
  {{285, 12, 36, 0, 6, 0.70215, 1, 0}, 5U, 285U},
  {{303, 12, 36, 0, 6, 0.70215, 1, 0}, 6U, 341U},
  // The parameters below correspond to the max SIB1 payload size (2976 bits, or 372 bytes).
  {{372, 12, 36, 0, 2, 0.37012, 1, 0}, 37U, 372U},
  ...
  // 478B.
  {{478, 12, 36, 0, 2, 0.37012, 1, 0}, 47U, 469U}
    // clang-format on
};
