...
{
  ASSERT_GT(UINT16_MAX, band_helper::get_band_from_dl_arfcn(530000U));
  ASSERT_EQ(UINT16_MAX, band_helper::get_band_from_dl_arfcn(5300000U));
  ASSERT_EQ(1, band_helper::get_band_from_dl_arfcn(423000U));
  ASSERT_EQ(3, band_helper::get_band_from_dl_arfcn(365000U));
  ASSERT_EQ(5, band_helper::get_band_from_dl_arfcn(175000U));
  ASSERT_EQ(7, band_helper::get_band_from_dl_arfcn(530000U));
  ASSERT_EQ(25, band_helper::get_band_from_dl_arfcn(399000U));
  ASSERT_EQ(34, band_helper::get_band_from_dl_arfcn(404000U));
  ASSERT_EQ(38, band_helper::get_band_from_dl_arfcn(515000U));
  ASSERT_EQ(41, band_helper::get_band_from_dl_arfcn(499900U));
  ASSERT_EQ(41, band_helper::get_band_from_dl_arfcn(504000U));
  ASSERT_EQ(50, band_helper::get_band_from_dl_arfcn(286500U));
  ASSERT_EQ(51, band_helper::get_band_from_dl_arfcn(285500U));
  ASSERT_EQ(70, band_helper::get_band_from_dl_arfcn(400000U));
  ASSERT_EQ(77, band_helper::get_band_from_dl_arfcn(630500U));
}
...
{
  ASSERT_TRUE(band_helper::is_paired_spectrum(1));
  ASSERT_TRUE(band_helper::is_paired_spectrum(3));
  ASSERT_TRUE(band_helper::is_paired_spectrum(7));
  ASSERT_TRUE(band_helper::is_paired_spectrum(25));
  ASSERT_TRUE(band_helper::is_paired_spectrum(28));
  ASSERT_TRUE(band_helper::is_paired_spectrum(66));
  ASSERT_TRUE(band_helper::is_paired_spectrum(74));
}

TEST(test_is_paired_spectrum, unpaired)
{
  ASSERT_FALSE(band_helper::is_paired_spectrum(34));
  ASSERT_FALSE(band_helper::is_paired_spectrum(40));
  ASSERT_FALSE(band_helper::is_paired_spectrum(51));
  ASSERT_FALSE(band_helper::is_paired_spectrum(75));
  ASSERT_FALSE(band_helper::is_paired_spectrum(76));
  ASSERT_FALSE(band_helper::is_paired_spectrum(77));
  ASSERT_FALSE(band_helper::is_paired_spectrum(79));
  ASSERT_FALSE(band_helper::is_paired_spectrum(81));
  ASSERT_FALSE(band_helper::is_paired_spectrum(84));
}

TEST(test_ssb_pattern, ssb_pattern_case_A)
{
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(1, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(3, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(25, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(34, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(38, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(39, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(41, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(51, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(66, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::A, band_helper::get_ssb_pattern(70, subcarrier_spacing::kHz15));
}

TEST(test_ssb_pattern, ssb_pattern_case_B)
{
  ASSERT_EQ(ssb_pattern_case::B, band_helper::get_ssb_pattern(5, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::B, band_helper::get_ssb_pattern(5, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::B, band_helper::get_ssb_pattern(66, subcarrier_spacing::kHz30));
}

TEST(test_ssb_pattern, ssb_pattern_case_C)
{
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(34, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(38, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(39, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(40, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(41, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(50, subcarrier_spacing::kHz30));
  ASSERT_EQ(ssb_pattern_case::C, band_helper::get_ssb_pattern(78, subcarrier_spacing::kHz30));
}

TEST(test_ssb_pattern, ssb_pattern_case_invalid)
{
  ASSERT_GT(ssb_pattern_case::invalid, band_helper::get_ssb_pattern(1, subcarrier_spacing::kHz15));
  ASSERT_EQ(ssb_pattern_case::invalid, band_helper::get_ssb_pattern(3, subcarrier_spacing::kHz30));
}
...
{
  ASSERT_EQ(25,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz5, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(52,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz10, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(79,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz15, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(106,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz20, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(133,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz25, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(160,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz30, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(216,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz40, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(270,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz50, subcarrier_spacing::kHz15, frequency_range::FR1));
  ASSERT_EQ(0,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz60, subcarrier_spacing::kHz15, frequency_range::FR1));
}

TEST(test_get_n_rbs_from_bw, scs_30kHz)
{
  ASSERT_EQ(11,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz5, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(24,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz10, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(38,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz15, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(51,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz20, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(65,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz25, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(78,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz30, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(133,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz50, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(162,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz60, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(189,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz70, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(217,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz80, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(245,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz90, subcarrier_spacing::kHz30, frequency_range::FR1));
  ASSERT_EQ(273,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz100, subcarrier_spacing::kHz30, frequency_range::FR1));
}

TEST(test_get_n_rbs_from_bw, scs_60kHz)
{
  ASSERT_EQ(0,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz5, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(11,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz10, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(18,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz15, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(24,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz20, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(31,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz25, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(38,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz30, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(51,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz40, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(65,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz50, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(79,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz60, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(93,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz70, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(107,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz80, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(121,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz90, subcarrier_spacing::kHz60, frequency_range::FR1));
  ASSERT_EQ(135,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz100, subcarrier_spacing::kHz60, frequency_range::FR1));
}

TEST(test_get_n_rbs_from_bw, invalid_cases)
{
  ASSERT_EQ(0,
            band_helper::get_n_rbs_from_bw(bs_channel_bw_fr1::MHz100, subcarrier_spacing::kHz60, frequency_range::FR2));
  ASSERT_EQ(
