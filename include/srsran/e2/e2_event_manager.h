...
public:
  ...
  std::map<uint32_t, std::unique_ptr<protocol_transaction_event_source<asn1::e2ap::ricsubscription_delete_request_s>>>
      sub_del_reqs;

  void add_sub_del_req(const asn1::e2ap::ri_crequest_id_s& ric_request_id, timer_factory timer)
  {
