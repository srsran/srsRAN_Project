...
/// \param[in] optimization_flag FFTW planning optimization mode.
...
create_dft_processor_factory_fftw(fftw_plan_optimization optimization_flag = fftw_plan_optimization::fftw_measure,
