...
/// [Implementation defined] Maximum number of Precoding RB Groups (PRGs) per beamforming PDU. Its value should never
/// exceed 275.
static constexpr size_t MAX_PRGS_PER_BEAFORMING_PDU = 1;
