...
///
/// \param[in] minimum_bandwidth_MHz   Band minimum bandwidth in MHz as per TS38.104 Table 5.3.5-1 for FR 1
...
/// \param[in] is_for_shared_spectrum  True if the band is restricted to operation with shared spectrum channel access,
///                                    as per Table 5.2-1, TS 38.104.
