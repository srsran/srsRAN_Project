...
/// [Implementation-defined] Maximum number of PUCCH resources handled by the PUCCH resource manager.
/// \remark See TS 38.331, "maxNrofPUCCH-Resources".
constexpr size_t MAX_NOF_CELL_PUCCH_RESOURCES{128};

/// Maximum number of common PUCCH resources handled by the PUCCH resource manager.
