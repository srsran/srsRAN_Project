...
static constexpr uint64_t MAX_NOF_CU_F1AP_UES = ((uint64_t)1 << 32);
...
static constexpr uint64_t MAX_NOF_DU_F1AP_UES = (static_cast<uint64_t>(1) << static_cast<uint64_t>(32U));
