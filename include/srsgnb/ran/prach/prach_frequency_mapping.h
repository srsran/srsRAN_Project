...
/// \return The requested PRACH frequency mapping information if the combination of input parameters combination is
/// valid, \c PRACH_FREQUENCY_MAPPING_INFORMATION_RESERVED otherwise.
