...
/// through which the lower layer (e.g. RLC) notifies the PDCP Tx entity in the CU-UP of successful delivery of PDCP
/// PDUs.
...
public:
  ...
  virtual void handle_delivered_sdu(uint32_t count) = 0;
};
