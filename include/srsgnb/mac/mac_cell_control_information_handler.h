...
#ifndef SRSGNB_MAC_MAC_CELL_CONTROL_INFORMATION_HANDLER_H
#define SRSGNB_MAC_MAC_CELL_CONTROL_INFORMATION_HANDLER_H
...
#endif // SRSGNB_MAC_MAC_CELL_CONTROL_INFORMATION_HANDLER_H
