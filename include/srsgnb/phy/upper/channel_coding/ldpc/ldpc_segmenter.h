...
public:
  ...
  /// according to TS38.212 Section 5.4.2.1. \param[out] described_segments    Segments (unpacked, one bit per entry)
  /// and corresponding metadata. \param[in]  transport_block       The transport block to segment_tx (packed, one byte
  /// per entry). \param[in]  cfg                   Parameters affecting splitting and codeblock metadata.
