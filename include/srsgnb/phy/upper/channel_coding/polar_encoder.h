#ifndef SRSGNB_PHY_UPPER_CHANNEL_CODING_POLAR_ENCODER_H
#define SRSGNB_PHY_UPPER_CHANNEL_CODING_POLAR_ENCODER_H
...
#endif // SRSGNB_PHY_UPPER_CHANNEL_CODING_POLAR_ENCODER_H
