...
/// The file is truncated and writen in binary format.
///
/// \param filename File name.
/// \param grid Resource grid to be printed.
/// \param nof_symbols Number of symbols.
/// \param nof_prbs Number of PRBs int the resource grid.
/// \param port Port of the resource grid to write.
