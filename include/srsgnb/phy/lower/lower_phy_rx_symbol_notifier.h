...
/// \brief Lower physical layer notifier that provides events related to received symbols.
///
/// The events generated by this interface are triggered by the requests handled by the \c lower_phy_request_handler
/// interface.
