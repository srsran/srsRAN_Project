                                                     ...
                                                     unsigned                       cell_nof_prbs)
{
  ...
  fill_codeword_information(builder, mac_pdu.pdsch_cfg.n_id, (mac_pdu.si_indicator == sib_information::other_si)? fapi::pdsch_ref_point_type::point_a : fapi::pdsch_ref_point_type::subcarrier_0);
