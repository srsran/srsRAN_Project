...
/// for the MAC layer.
class fapi_to_mac_data_msg_fastpath_translator : public fapi::slot_data_message_notifier
{
public:
  fapi_to_mac_data_msg_fastpath_translator(subcarrier_spacing scs_, unsigned sector_id_);
