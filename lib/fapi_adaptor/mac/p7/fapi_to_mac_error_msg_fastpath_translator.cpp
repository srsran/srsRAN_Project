...
fapi_to_mac_error_msg_fastpath_translator::fapi_to_mac_error_msg_fastpath_translator(subcarrier_spacing scs_) :
...
void fapi_to_mac_error_msg_fastpath_translator::on_error_indication(const fapi::error_indication_message& msg)
{
