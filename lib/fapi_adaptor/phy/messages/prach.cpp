                                                     ...
                                                     const fapi::multi_prach_config& prach_config_tlv)
{
  ...
  const prach_config&             config   = prach_config_tlv.prachs[fapi_pdu.maintenance_v3.prach_res_config_index];
  const prach_fd_occasion_config& fd_occas = config.fd_occasions.back();
  ...
  context.frequency_offset                 = fd_occas.prach_freq_offset;
