...
cu_up_processor_routine_manager::cu_up_processor_routine_manager(
  ...
  context(context_), e1_conn_mng(e1_conn_mng_), cu_cp_notifier(cu_cp_notifier_), task_sched(task_sched_)
{
}
...
void cu_up_processor_routine_manager::start_initial_cu_up_processor_setup_routine()
{
  task_sched.schedule_async_task(
      context.cu_up_index, launch_async<initial_cu_up_processor_setup_routine>(context, e1_conn_mng, cu_cp_notifier));
}
