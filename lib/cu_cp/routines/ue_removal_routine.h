...
private:
  ...
  std::unordered_map<ue_index_t, ngap_rrc_ue_adapter>&  ngap_rrc_ue_ev_notifiers;  // to remove the UE from lookups
  std::unordered_map<ue_index_t, cu_cp_rrc_ue_adapter>& cu_cp_rrc_ue_ev_notifiers; // to remove the UE from lookups
