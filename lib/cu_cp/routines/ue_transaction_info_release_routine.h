...
private:
  ...
  void prepare_f1_reset_messages();
  ...
  // F1 reset messages per DU.
  std::map<du_index_t, cu_cp_reset>           f1_reset_per_du;
  std::map<du_index_t, cu_cp_reset>::iterator du_id_it;
  du_processor*                               du = nullptr;
