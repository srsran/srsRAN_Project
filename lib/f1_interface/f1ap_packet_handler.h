...
//   /// This is important as the dependency with f1ap_packet_procedures interface would eventually disappear, although
//   it
//   /// is an interface and not a concrete class the less dependencies the better.
//   std::unique_ptr<f1ap_packet_procedures> procedure;
//
// public:
//   explicit f1ap_du_packet_handler(std::unique_ptr<f1ap_packet_procedures> procedure) :
