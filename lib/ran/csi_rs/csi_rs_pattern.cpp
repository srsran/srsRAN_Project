                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 1: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::three, "CSI-RS Mapping Row 1: invalid density");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 2: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one ||
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 3: invalid number of ports");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 4: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 4: invalid density");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 5: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 5: invalid density");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 6: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 6: invalid density");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 7: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 7: invalid density");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 8: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 8: invalid density");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 9: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 9: invalid density");
                           ...
                           const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 10: invalid number of ports");
  ...
  srsgnb_assert(config.freq_density == csi_rs_freq_density_type::one, "CSI-RS Mapping Row 10: invalid density");
                           ...
                           const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 11: invalid number of ports");
                           ...
                           const csi_rs_pattern_configuration& config)
{
  ...
  srsgnb_assert(config.nof_ports == NOF_PORTS, "CSI-RS Mapping Row 12: invalid number of ports");
