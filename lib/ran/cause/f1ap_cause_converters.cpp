...
static constexpr uint8_t f1ap_to_nrppa_cause_radio_network[] = {
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unspecified
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // rl_fail_rlc
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_already_allocated_gnb_cu_ue_f1ap_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_already_allocated_gnb_du_ue_f1ap_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_inconsistent_pair_of_ue_f1ap_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // interaction_with_other_proc
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // not_supported_qci_value
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // action_desirable_for_radio_reasons
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // no_radio_res_available
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // proc_cancelled
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // normal_release
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // cell_not_available
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // rl_fail_others
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // ue_rejection
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // res_not_available_for_the_slice
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // amf_initiated_abnormal_release
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // release_due_to_pre_emption
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // plmn_not_served_by_the_gnb_cu
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // multiple_drb_id_instances
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_drb_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // multiple_bh_rlc_ch_id_instances
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_bh_rlc_ch_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // cho_cpc_res_tobechanged
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // npn_not_supported
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // npn_access_denied
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // gnb_cu_cell_capacity_exceeded
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // report_characteristics_empty
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // existing_meas_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // meas_temporarily_not_available
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // meas_not_supported_for_the_obj
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_bh_address
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_bap_routing_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // insufficient_ue_cap
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // scg_activation_deactivation_fail
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // scg_deactivation_fail_due_to_data_tx
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // requested_item_not_supported_on_time
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_already_allocated_gnb_cu_mbs_f1ap_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_already_allocated_gnb_du_mbs_f1ap_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_inconsistent_pair_of_mbs_f1ap_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified, // unknown_or_inconsistent_mrb_id
    (uint8_t)nrppa_cause_radio_network_t::unspecified  // tat_sdt_expiry
};
...
static constexpr uint8_t f1ap_to_nrppa_cause_misc[] = {
    (uint8_t)nrppa_cause_misc_t::unspecified, // ctrl_processing_overload
    (uint8_t)nrppa_cause_misc_t::unspecified, // not_enough_user_plane_processing_res
    (uint8_t)nrppa_cause_misc_t::unspecified, // hardware_fail
    (uint8_t)nrppa_cause_misc_t::unspecified, // om_intervention
    (uint8_t)nrppa_cause_misc_t::unspecified  // unspecified
};
...
nrppa_cause_t srsran::f1ap_to_nrppa_cause(f1ap_cause_t f1ap_cause)
{
  ...
  if (const auto* result = std::get_if<f1ap_cause_radio_network_t>(&f1ap_cause)) {
    nrppa_cause = nrppa_cause_radio_network_t(f1ap_to_nrppa_cause_radio_network[uint8_t(*result)]);
    return nrppa_cause;
  }
  ...
  if (const auto* result = std::get_if<cause_misc_t>(&f1ap_cause)) {
    nrppa_cause = nrppa_cause_misc_t(f1ap_to_nrppa_cause_misc[uint8_t(*result)]);
    return nrppa_cause;
  }
