...
public:
  ...
  virtual void dl_sched(ue_pdsch_allocator& pdsch_alloc, const ue_list& ues, bool is_retx) = 0;
  ...
  virtual void ul_sched(ue_pusch_allocator& pusch_alloc, const ue_list& ues, bool is_retx) = 0;
};
