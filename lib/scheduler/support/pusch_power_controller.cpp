...
{
  if (ue_cell_cfg.ul_cfg() != nullptr and ue_cell_cfg.ul_cfg()->init_ul_bwp.pusch_cfg.has_value() and
      ue_cell_cfg.ul_cfg()->init_ul_bwp.pusch_cfg.value().pusch_pwr_ctrl.has_value()) {
    pusch_pwr_ctrl.emplace(ue_cell_cfg.ul_cfg()->init_ul_bwp.pusch_cfg.value().pusch_pwr_ctrl.value());
  }
}
