...
unsigned type0_pdcch_css_n0_is_even_frame(const double   table_13_11_and_13_12_O,
                                          const double   table_13_11_and_13_12_M,
                                          const uint8_t  numerology_mu,
                                          const unsigned ssb_index)
{
...
slot_point get_type0_pdcch_css_n0(const double             table_13_11_and_13_12_O,
                                  const double             table_13_11_and_13_12_M,
...
/// \return Returns slot n0 where UE should monitor Type0-PDCCH CSS.
slot_point precompute_type0_pdcch_css_n0(const uint8_t             searchspace0,
                                         ...
                                         const unsigned            ssb_index)
{
  ...
  srsgnb_assert(min_channel_bw < min_channel_bandwidth::MHz40,
                "Bands with minimum channel BW 40MHz not supported for Paging scheduling");
  ...
  srsgnb_assert(band_helper::get_freq_range(cell_cfg.dl_carrier.band) == frequency_range::FR1,
                "Paging scheduler only supports FR1.");
