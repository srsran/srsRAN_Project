...
public:
  ...
  /// Returns whether an UCI HARQ-ACK allocated on common PUCCH resource exists at a given slot or not.
  /// \param[in] crnti C-RNTI of the UE.
  /// \param[in] sl_tx UCI slot.
  /// \return Returns true if an UCI HARQ-ACK allocated on common PUCCH resource exists. False, otherwise.
