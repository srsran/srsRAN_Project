...
{
public:
  explicit ru_uplink_request_handler_generic_impl(lower_phy_request_handler& low_phy_handler_) :
    low_phy_handler(low_phy_handler_)
  {
  }
...
private:
  lower_phy_request_handler& low_phy_handler;
};
