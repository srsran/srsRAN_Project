...
{
public:
  explicit ru_downlink_plane_handler_proxy(std::vector<std::pair<ofh::downlink_handler*, task_executor*>> sectors_) :
...
private:
  std::vector<std::pair<ofh::downlink_handler*, task_executor*>> sectors;
};
