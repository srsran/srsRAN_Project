...
/// \param[in] nof_res_f1 number of PUCCH F0/F1 resources to be generated.
/// \param[in] nof_res_f2 number of PUCCH F2 resources to be generated.
/// \param[in] f1_params PUCCH F0/F1 resource parameters.
...
///
/// PUCCH resources F0/F1 and F2 are allocated on different RBs. The function attempts to spread the resources on both
/// sides of the BWP.
///
...
///
/// This function generates the list of PUCCH F0/F1 and F2 resources for a given UE, including the resources for
/// HARQ-ACK reporting, SR and CSI. It also updates the PUCCH resource sets accordingly, as well as the pointers to the
/// PUCCH F0/F1 resource for SR and to the PUCCH F2 resource for CSI. This function overwrites the default \c
