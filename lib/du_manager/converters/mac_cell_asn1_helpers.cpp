                                         ...
                                         subcarrier_spacing                                 ssb_scs)
{
  ...
  // TDD Configuration.
  if (serv_cll_sib_in.tdd_ul_dl_cfg_common_present) {
    out.tdd_cfg.emplace();
    fill_tdd_cfg_from_asn1(serv_cll_sib_in.tdd_ul_dl_cfg_common, out.tdd_cfg.value());
  }

  fill_ssb_configuration_from_asn1(out.ssb_cfg, mib_in, serv_cll_sib_in, ssb_scs);
}
