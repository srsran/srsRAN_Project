                                       ...
                                       const ru_compression_params& params)
{
  ...
  bool iq_width_supported = mm256::iq_width_packing_supported(params.data_width);
                                         ...
                                         const ru_compression_params& params)
{
  ...
  for (const compressed_prb& c_prb : input) {
    bool simd_support_for_iq_width = mm256::iq_width_packing_supported(params.data_width);
