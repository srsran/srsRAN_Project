...
async_task<mac_ue_create_response_message> mac_controller::handle_ue_create_request(const mac_ue_create_request_message& msg)
{
  // Launch UE create request procedure
  return launch_async<mac_ue_create_request_procedure>(msg, cfg, *this, ul_unit, dl_unit);
}

async_task<mac_ue_delete_response_message> mac_controller::handle_ue_delete_request(const mac_ue_delete_request_message& msg)
{
