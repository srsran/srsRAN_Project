...
public:
  ...
  virtual lazy_task<bool> add_ue(const mac_ue_create_request_message& msg)                  = 0;
  virtual lazy_task<bool> reconfigure_ue(const mac_ue_reconfiguration_request_message& msg) = 0;
  virtual lazy_task<void> remove_ue(const mac_ue_delete_request_message& msg)               = 0;
};
