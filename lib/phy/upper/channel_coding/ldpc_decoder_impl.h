...
#ifndef SRSGNB_LIB_PHY_UPPER_CHANNEL_CODING_LDPC_DECODER_IMPL_H
#define SRSGNB_LIB_PHY_UPPER_CHANNEL_CODING_LDPC_DECODER_IMPL_H
...
#endif // SRSGNB_LIB_PHY_UPPER_CHANNEL_CODING_LDPC_DECODER_IMPL_H