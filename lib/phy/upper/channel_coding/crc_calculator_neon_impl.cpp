...
crc_calculator_checksum_t crc_calculator_neon_impl::calculate_byte(span<const uint8_t> data)
{
...
crc_calculator_checksum_t crc_calculator_neon_impl::calculate_bit(span<const uint8_t> data)
{
  return crc_calc_lut.calculate_bit(data);
}

crc_calculator_checksum_t crc_calculator_neon_impl::calculate(const bit_buffer& data)
{
