                                                  ...
                                                  span<log_likelihood_ratio> this_check_to_var)
{
  ...
  const neon::neon_span soft_bits_neon(this_soft_bits, neon_blocks);
  const neon::neon_span check_to_var_neon(this_check_to_var, neon_blocks);
...
void ldpc_decoder_neon::compute_soft_bits(span<log_likelihood_ratio> this_soft_bits,
                                          ...
                                          span<log_likelihood_ratio> this_check_to_var)
{
  const neon::neon_span this_check_to_var_neon(this_check_to_var, node_size_neon);
  const neon::neon_span this_var_to_check_neon(this_var_to_check, node_size_neon);
...
void ldpc_decoder_neon::get_hard_bits(bit_buffer& out)
{
  ...
  neon::neon_span soft_bits_neon(soft_bits, max_node_lifted);
  ...
  for (unsigned i_node_lifted = 0; i_node_lifted != max_node_lifted; i_node_lifted += node_size_neon) {
    ...
    span<const log_likelihood_ratio> current_soft(
        reinterpret_cast<log_likelihood_ratio*>(soft_bits_neon.data_at(i_node_lifted, 0)), lifting_size);
