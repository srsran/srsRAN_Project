...
#ifndef SRSGNB_LIB_PHY_UPPER_SIGNAL_PROCESSORS_SSS_PROCESSOR_IMPL_H
#define SRSGNB_LIB_PHY_UPPER_SIGNAL_PROCESSORS_SSS_PROCESSOR_IMPL_H
...
#endif // SRSGNB_LIB_PHY_UPPER_SIGNAL_PROCESSORS_SSS_PROCESSOR_IMPL_H
