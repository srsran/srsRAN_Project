...
prb_bitmap rb_allocation::get_contiguous_prb_mask(unsigned bwp_start_rb, unsigned bwp_size_rb) const
{
  ...
  prb_bitmap prb_mask(bwp_start_rb + bwp_size_rb);
...
prb_bitmap rb_allocation::get_other_prb_mask(unsigned bwp_start_rb, unsigned bwp_size_rb) const
{
  prb_bitmap                            result(bwp_start_rb + bwp_size_rb);
...
prb_bitmap rb_allocation::get_prb_mask(unsigned bwp_start_rb, unsigned bwp_size_rb) const
{
