...
#include "pusch_processor_logging_decorator.h"
...
class pusch_processor_logging_decorator : public pusch_processor, private pusch_processor_result_notifier
{
public:
  pusch_processor_logging_decorator(srslog::basic_logger& logger_, std::unique_ptr<pusch_processor> processor_) :
