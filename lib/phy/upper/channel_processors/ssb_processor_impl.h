 ...
 *
 */
#ifndef SRSGNB_CHANNEL_PROCESSORS_SSB_PROCESSOR_IMPL_H_
#define SRSGNB_CHANNEL_PROCESSORS_SSB_PROCESSOR_IMPL_H_
...
#endif // SRSGNB_CHANNEL_PROCESSORS_SSB_PROCESSOR_IMPL_H_
