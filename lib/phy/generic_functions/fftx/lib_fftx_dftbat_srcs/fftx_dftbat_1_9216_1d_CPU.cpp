...
#include <stdint.h>
static float D1[192];
static float D2[18432];
static float D3[192];

extern "C" {
void init_fftx_dftbat_1_9216_1d_CPU()
{
    ...
    for (int i10 = 0; i10 <= 7; i10++) {
      for (int i22 = 0; i22 <= 2; i22++) {
        for (int i41 = 0; i41 <= 1; i41++) {
          D2[((192 * i3) + (24 * i10) + (8 * i22) + (4 * i41))] =
              cospi((((float)(18430 * (i3 * ((24 * i41) + (8 * i22) + i10)))) / 9216));
          D2[(1 + (192 * i3) + (24 * i10) + (8 * i22) + (4 * i41))] =
              sinpi((((float)(18430 * (i3 * ((24 * i41) + (8 * i22) + i10)))) / 9216));
          D2[(2 + (192 * i3) + (24 * i10) + (8 * i22) + (4 * i41))] =
              cospi((((float)(18430 * (i3 * (48 + (24 * i41) + (8 * i22) + i10)))) / 9216));
          D2[(3 + (192 * i3) + (24 * i10) + (8 * i22) + (4 * i41))] =
              sinpi((((float)(18430 * (i3 * (48 + (24 * i41) + (8 * i22) + i10)))) / 9216));
        }
      }
    }
  }
  for (int i11 = 0; i11 <= 11; i11++) {
    for (int i26 = 0; i26 <= 1; i26++) {
      for (int i48 = 0; i48 <= 1; i48++) {
        D3[((16 * i11) + (8 * i26) + (4 * i48))]     = cospi((((float)(190 * (i11 * ((2 * i48) + i26)))) / 96));
        D3[(1 + (16 * i11) + (8 * i26) + (4 * i48))] = sinpi((((float)(190 * (i11 * ((2 * i48) + i26)))) / 96));
        D3[(2 + (16 * i11) + (8 * i26) + (4 * i48))] = cospi((((float)(190 * (i11 * (4 + (2 * i48) + i26)))) / 96));
        D3[(3 + (16 * i11) + (8 * i26) + (4 * i48))] = sinpi((((float)(190 * (i11 * (4 + (2 * i48) + i26)))) / 96));
      }
    }
  }
}
...
extern "C" {
void fftx_dftbat_1_9216_1d_CPU(float* Y, float* X)
{
  static float T1[18432];
  for (int i3 = 0; i3 <= 95; i3++) {
    static float T2[192];
    for (int i11 = 0; i11 <= 11; i11++) {
  ...
  for (int i2 = 0; i2 <= 95; i2++) {
    ...
    for (int i6 = 0; i6 <= 7; i6++) {
      float s450, s451, s452, s453, s454, s455, s456, s457, s458, s459, s460, s461, s462, s463, s464, s465, s466, s467,
          s468, s469, s470, s471, s472, s473, s474, s475, s476, s477, s478, s479, s480, s481, t1000, t1001, t1002,
          t1003, t1004, t1005, t1006, t1007, t1008, t1009, t1010, t1011, t1012, t1013, t1014, t1015, t1016, t1017,
          t1018, t1019, t1020, t1021, t1022, t1023, t1024, t1025, t1026, t1027, t1028, t1029, t1030, t1031, t1032,
          t1033, t1034, t1035, t1036, t1037, t1038, t1039, t1040, t1041, t994, t995, t996, t997, t998, t999;
      int a1587, a1588, a1589, a1590, a1591, a1592, a1593, a1594, a1595, a1596, a1597, a1598, a1599, a1600, a1601,
          a1602, a1603, a1604, a1605, a1606, a1607, a1608, a1609, a1610, a1611;
      a1587                  = (2 * i6);
      a1588                  = (a1587 + 1);
      a1589                  = (a1587 + 64);
      a1590                  = (a1587 + 65);
      a1591                  = (a1587 + 128);
      a1592                  = (a1587 + 129);
      t994                   = (*((T32 + a1589)) + *((T32 + a1591)));
      t995                   = (*((T32 + a1590)) + *((T32 + a1592)));
      s450                   = (*((T32 + a1587)) + t994);
      s451                   = (*((T32 + a1588)) + t995);
      s452                   = (*((T32 + a1587)) - (0.5 * t994));
      s453                   = (*((T32 + a1588)) - (0.5 * t995));
      s454                   = (0.8660254037844386 * (*((T32 + a1590)) - *((T32 + a1592))));
      s455                   = (0.8660254037844386 * (*((T32 + a1589)) - *((T32 + a1591))));
      t996                   = (s452 + s454);
      t997                   = (s453 - s455);
      t998                   = (s452 - s454);
      t999                   = (s453 + s455);
      ...
      a1597                  = (a1587 + 144);
      a1598                  = (a1587 + 145);
      t1000                  = (*((T32 + a1595)) + *((T32 + a1597)));
      t1001                  = (*((T32 + a1596)) + *((T32 + a1598)));
      s456                   = (*((T32 + a1593)) + t1000);
      s457                   = (*((T32 + a1594)) + t1001);
      s458                   = (*((T32 + a1593)) - (0.5 * t1000));
      s459                   = (*((T32 + a1594)) - (0.5 * t1001));
      s460                   = (0.8660254037844386 * (*((T32 + a1596)) - *((T32 + a1598))));
      s461                   = (0.8660254037844386 * (*((T32 + a1595)) - *((T32 + a1597))));
      t1002                  = (s458 + s460);
      t1003                  = (s459 - s461);
      t1004                  = (s458 - s460);
      t1005                  = (s459 + s461);
      s462                   = ((0.8660254037844386 * t1002) + (0.5 * t1003));
      s463                   = ((0.8660254037844386 * t1003) - (0.5 * t1002));
      s464                   = ((0.5 * t1004) + (0.8660254037844386 * t1005));
      s465                   = ((0.5 * t1005) - (0.8660254037844386 * t1004));
      a1599                  = (a1587 + 32);
      a1600                  = (a1587 + 33);
      a1601                  = (a1587 + 96);
      a1602                  = (a1587 + 97);
      a1603                  = (a1587 + 160);
      a1604                  = (a1587 + 161);
      t1006                  = (*((T32 + a1601)) + *((T32 + a1603)));
      t1007                  = (*((T32 + a1602)) + *((T32 + a1604)));
      s466                   = (*((T32 + a1599)) + t1006);
      s467                   = (*((T32 + a1600)) + t1007);
      s468                   = (*((T32 + a1599)) - (0.5 * t1006));
      s469                   = (*((T32 + a1600)) - (0.5 * t1007));
      s470                   = (0.8660254037844386 * (*((T32 + a1602)) - *((T32 + a1604))));
      s471                   = (0.8660254037844386 * (*((T32 + a1601)) - *((T32 + a1603))));
      t1008                  = (s468 + s470);
      t1009                  = (s469 - s471);
      t1010                  = (s468 - s470);
      t1011                  = (s469 + s471);
      s472                   = ((0.5 * t1008) + (0.8660254037844386 * t1009));
      s473                   = ((0.5 * t1009) - (0.8660254037844386 * t1008));
      s474                   = ((0.8660254037844386 * t1011) - (0.5 * t1010));
      s475                   = ((0.8660254037844386 * t1010) + (0.5 * t1011));
      a1605                  = (a1587 + 48);
      a1606                  = (a1587 + 49);
      a1607                  = (a1587 + 112);
      a1608                  = (a1587 + 113);
      a1609                  = (a1587 + 176);
      a1610                  = (a1587 + 177);
      t1012                  = (*((T32 + a1607)) + *((T32 + a1609)));
      t1013                  = (*((T32 + a1608)) + *((T32 + a1610)));
      s476                   = (*((T32 + a1605)) + t1012);
      s477                   = (*((T32 + a1606)) + t1013);
      s478                   = (*((T32 + a1605)) - (0.5 * t1012));
      s479                   = (*((T32 + a1606)) - (0.5 * t1013));
      s480                   = (0.8660254037844386 * (*((T32 + a1608)) - *((T32 + a1610))));
      s481                   = (0.8660254037844386 * (*((T32 + a1607)) - *((T32 + a1609))));
      t1014                  = (s478 + s480);
      t1015                  = (s479 - s481);
      t1016                  = (s478 - s480);
      t1017                  = (s479 + s481);
      ...
      a1611                  = ((2 * i2) + (192 * i6));
      *((Y + a1611))         = (t1018 + t1022);
      *((1 + Y + a1611))     = (t1019 + t1023);
      *((9216 + Y + a1611))  = (t1018 - t1022);
      *((9217 + Y + a1611))  = (t1019 - t1023);
      *((4608 + Y + a1611))  = (t1020 + t1025);
      *((4609 + Y + a1611))  = (t1021 - t1024);
      *((13824 + Y + a1611)) = (t1020 - t1025);
      *((13825 + Y + a1611)) = (t1021 + t1024);
      t1026                  = (t996 + s472);
      t1027                  = (t997 + s473);
      t1028                  = (t996 - s472);
      t1029                  = (t997 - s473);
      ...
      t1032                  = (s462 - t1015);
      t1033                  = (s463 + t1014);
      *((1536 + Y + a1611))  = (t1026 + t1030);
      *((1537 + Y + a1611))  = (t1027 + t1031);
      *((10752 + Y + a1611)) = (t1026 - t1030);
      *((10753 + Y + a1611)) = (t1027 - t1031);
      *((6144 + Y + a1611))  = (t1028 + t1033);
      *((6145 + Y + a1611))  = (t1029 - t1032);
      *((15360 + Y + a1611)) = (t1028 - t1033);
      *((15361 + Y + a1611)) = (t1029 + t1032);
      t1034                  = (t998 + s474);
      t1035                  = (t999 - s475);
      t1036                  = (t998 - s474);
      t1037                  = (t999 + s475);
      ...
      t1040                  = (s464 + t1016);
      t1041                  = (s465 + t1017);
      *((3072 + Y + a1611))  = (t1034 + t1038);
      *((3073 + Y + a1611))  = (t1035 + t1039);
      *((12288 + Y + a1611)) = (t1034 - t1038);
      *((12289 + Y + a1611)) = (t1035 - t1039);
      *((7680 + Y + a1611))  = (t1036 + t1041);
      *((7681 + Y + a1611))  = (t1037 - t1040);
      *((16896 + Y + a1611)) = (t1036 - t1041);
      *((16897 + Y + a1611)) = (t1037 + t1040);
    }
  }
}
}
...
extern "C" {
void destroy_fftx_dftbat_1_9216_1d_CPU()
{
  /* skip */
}
}
