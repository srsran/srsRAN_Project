...
extern "C" {
void init_fftx_idftbat_1_384_1d_CPU()
{
  for (int i7 = 0; i7 <= 5; i7++) {
    for (int i18 = 0; i18 <= 1; i18++) {
      D1[((8 * i7) + (4 * i18))]     = cospi((((float)(2 * (i7 * i18))) / 24));
      D1[(1 + (8 * i7) + (4 * i18))] = sinpi((((float)(2 * (i7 * i18))) / 24));
      D1[(2 + (8 * i7) + (4 * i18))] = cospi((((float)(2 * (i7 * (2 + i18)))) / 24));
      D1[(3 + (8 * i7) + (4 * i18))] = sinpi((((float)(2 * (i7 * (2 + i18)))) / 24));
    }
  }
  for (int i3 = 0; i3 <= 23; i3++) {
    for (int i10 = 0; i10 <= 3; i10++) {
      for (int i22 = 0; i22 <= 1; i22++) {
        D2[((32 * i3) + (8 * i10) + (4 * i22))]     = cospi((((float)(2 * (i3 * ((4 * i22) + i10)))) / 384));
        D2[(1 + (32 * i3) + (8 * i10) + (4 * i22))] = sinpi((((float)(2 * (i3 * ((4 * i22) + i10)))) / 384));
        D2[(2 + (32 * i3) + (8 * i10) + (4 * i22))] = cospi((((float)(2 * (i3 * (8 + (4 * i22) + i10)))) / 384));
        D2[(3 + (32 * i3) + (8 * i10) + (4 * i22))] = sinpi((((float)(2 * (i3 * (8 + (4 * i22) + i10)))) / 384));
      }
    }
  }
}
...
extern "C" {
void fftx_idftbat_1_384_1d_CPU(float* Y, float* X)
{
  static float T1[768];
  for (int i3 = 0; i3 <= 23; i3++) {
    ...
    s148           = ((0.38268343236508978 * t476) + (0.92387953251128674 * t477));
    s149           = ((0.38268343236508978 * t478) - (0.92387953251128674 * t479));
    s150           = ((0.92387953251128674 * t478) + (0.38268343236508978 * t479));
    a656           = (a638 + 96);
    a657           = (a638 + 97);
    a658           = (a638 + 480);
    a659           = (a638 + 481);
    ...
    s151           = (a664 - a665);
    s152           = (a664 + a665);
    a666           = (0.70710678118654757 * (t482 + t487));
    a667           = (0.70710678118654757 * (t483 - t486));
    s153           = (a666 + a667);
    s154           = (a666 - a667);
    a668           = (a638 + 144);
    a669           = (a638 + 145);
    ...
    t500           = (t492 + t496);
    t501           = (t493 + t497);
    a676           = (0.70710678118654757 * (t492 - t496));
    a677           = (0.70710678118654757 * (t493 - t497));
    s155           = (a676 + a677);
    s156           = (a676 - a677);
    t502           = (t494 - t499);
    t503           = (t495 + t498);
    ...
    s158           = ((0.92387953251128674 * t502) + (0.38268343236508978 * t503));
    s159           = ((0.38268343236508978 * t505) - (0.92387953251128674 * t504));
  ...
  for (int i2 = 0; i2 <= 15; i2++) {
    ...
    for (int i6 = 0; i6 <= 3; i6++) {
      float s241, s242, s243, s244, s245, s246, s247, s248, s249, s250, s251, s252, t706, t707, t708, t709, t710, t711,
          t712, t713, t714, t715, t716, t717, t718, t719, t720, t721;
      int a1000, a1001, a1002, a1003, a1004, a1005, a1006, a1007, a1008, a1009, a1010, a1011, a999;
      a999                 = (2 * i6);
      a1000                = (a999 + 1);
      a1001                = (a999 + 24);
      a1002                = (a999 + 25);
      t706                 = (*((T17 + a999)) + *((T17 + a1001)));
      t707                 = (*((T17 + a1000)) + *((T17 + a1002)));
      t708                 = (*((T17 + a999)) - *((T17 + a1001)));
      t709                 = (*((T17 + a1000)) - *((T17 + a1002)));
      a1003                = (a999 + 8);
      a1004                = (a999 + 9);
      a1005                = (a999 + 32);
      a1006                = (a999 + 33);
      t710                 = (*((T17 + a1003)) + *((T17 + a1005)));
      t711                 = (*((T17 + a1004)) + *((T17 + a1006)));
      t712                 = (*((T17 + a1003)) - *((T17 + a1005)));
      t713                 = (*((T17 + a1004)) - *((T17 + a1006)));
      s241                 = ((0.5 * t712) - (0.8660254037844386 * t713));
      s242                 = ((0.8660254037844386 * t712) + (0.5 * t713));
      a1007                = (a999 + 16);
      a1008                = (a999 + 17);
      a1009                = (a999 + 40);
      a1010                = (a999 + 41);
      t714                 = (*((T17 + a1007)) + *((T17 + a1009)));
      t715                 = (*((T17 + a1008)) + *((T17 + a1010)));
      t716                 = (*((T17 + a1007)) - *((T17 + a1009)));
      t717                 = (*((T17 + a1008)) - *((T17 + a1010)));
      s243                 = ((0.5 * t716) + (0.8660254037844386 * t717));
      s244                 = ((0.8660254037844386 * t716) - (0.5 * t717));
      t718                 = (t710 + t714);
      t719                 = (t711 + t715);
      s245                 = (t706 - (0.5 * t718));
      s246                 = (t707 - (0.5 * t719));
      s247                 = (0.8660254037844386 * (t711 - t715));
      s248                 = (0.8660254037844386 * (t710 - t714));
      a1011                = ((2 * i2) + (32 * i6));
      *((Y + a1011))       = (t706 + t718);
      *((1 + Y + a1011))   = (t707 + t719);
      *((256 + Y + a1011)) = (s245 - s247);
      *((257 + Y + a1011)) = (s246 + s248);
      *((512 + Y + a1011)) = (s245 + s247);
      *((513 + Y + a1011)) = (s246 - s248);
      t720                 = (s241 - s243);
      t721                 = (s242 + s244);
      s249                 = (t708 - (0.5 * t720));
      s250                 = (t709 - (0.5 * t721));
      s251                 = (0.8660254037844386 * (s242 - s244));
      s252                 = (0.8660254037844386 * (s241 + s243));
      *((128 + Y + a1011)) = (t708 + t720);
      *((129 + Y + a1011)) = (t709 + t721);
      *((384 + Y + a1011)) = (s249 - s251);
      *((385 + Y + a1011)) = (s250 + s252);
      *((640 + Y + a1011)) = (s249 + s251);
      *((641 + Y + a1011)) = (s250 - s252);
    }
  }
}
}
...
extern "C" {
void destroy_fftx_idftbat_1_384_1d_CPU()
{
  /* skip */
}
}
