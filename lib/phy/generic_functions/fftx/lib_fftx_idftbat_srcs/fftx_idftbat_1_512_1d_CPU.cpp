...
extern "C" {
void init_fftx_idftbat_1_512_1d_CPU()
{
  ...
  for (int i3 = 0; i3 <= 31; i3++) {
    for (int i10 = 0; i10 <= 3; i10++) {
      for (int i22 = 0; i22 <= 1; i22++) {
        D2[((32 * i3) + (8 * i10) + (4 * i22))]     = cospi((((float)(2 * (i3 * ((4 * i22) + i10)))) / 512));
        D2[(1 + (32 * i3) + (8 * i10) + (4 * i22))] = sinpi((((float)(2 * (i3 * ((4 * i22) + i10)))) / 512));
        D2[(2 + (32 * i3) + (8 * i10) + (4 * i22))] = cospi((((float)(2 * (i3 * (8 + (4 * i22) + i10)))) / 512));
        D2[(3 + (32 * i3) + (8 * i10) + (4 * i22))] = sinpi((((float)(2 * (i3 * (8 + (4 * i22) + i10)))) / 512));
      }
    }
  }
}
...
extern "C" {
void fftx_idftbat_1_512_1d_CPU(float* Y, float* X)
{
  ...
  for (int i2 = 0; i2 <= 15; i2++) {
    ...
    for (int i6 = 0; i6 <= 3; i6++) {
      ...
      a1041                = (0.70710678118654757 * (*((T17 + a1037)) - *((T17 + a1039))));
      a1042                = (0.70710678118654757 * (*((T17 + a1038)) - *((T17 + a1040))));
      s215                 = (a1041 + a1042);
      s216                 = (a1041 - a1042);
      t770                 = (t758 + t764);
      t771                 = (t759 + t765);
...
extern "C" {
void destroy_fftx_idftbat_1_512_1d_CPU()
{
  /* skip */
}
}
