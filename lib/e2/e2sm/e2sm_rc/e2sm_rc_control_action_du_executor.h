...
public:
  ...
  execute_ric_control_action(const e2_sm_ric_control_request_s& req) override = 0;
...
public:
  ...
  async_task<e2_sm_ric_control_response_s> execute_ric_control_action(const e2_sm_ric_control_request_s& req) override;

private:
  du_mac_sched_control_config  convert_to_du_config_request(const e2_sm_ric_control_request_s& e2sm_req_);
  e2_sm_ric_control_response_s convert_to_e2sm_response(const du_mac_sched_control_config&          du_config_req_,
