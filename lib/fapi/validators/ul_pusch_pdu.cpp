...
bool srsgnb::fapi::validate_ul_pusch_pdu(const ul_pusch_pdu& pdu, validator_report& report)
{
  bool result = true;
  ...
  if (check_bitmap_bit(pdu.pdu_bitmap, ul_pusch_pdu::PUSCH_DATA_BIT)) {
  ...
  if (check_bitmap_bit(pdu.pdu_bitmap, ul_pusch_pdu::PUSCH_UCI_BIT)) {
  ...
  if (check_bitmap_bit(pdu.pdu_bitmap, ul_pusch_pdu::PUSCH_PTRS_BIT)) {
  ...
  if (check_bitmap_bit(pdu.pdu_bitmap, ul_pusch_pdu::DFTS_OFDM_BIT)) {
