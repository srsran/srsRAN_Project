...
/// Maximum number of PUCCH F2/F3 resources per UE for HARQ-ACK reporting.
constexpr unsigned max_ue_f2_f3_res_harq = 8;
...
/// \param[in] nof_res_f2_f3 number of PUCCH F2/F3 resources to be generated.
/// \param[in] f0_f1_params PUCCH F0/F1 resource parameters.
/// \param[in] f2_f3_params PUCCH F2 resource parameters.
...
/// \brief Generates the list of cell PUCCH resources (Format 0/1 and 2/3) given the number of requested resources.
///
/// PUCCH resources F0/F1 and F2/F3 are allocated on different RBs. The function attempts to spread the resources on
/// both sides of the BWP.
///
/// \param[in] nof_res_f0_f1   number of PUCCH F0/F1 resources to be generated.
/// \param[in] nof_res_f2_f3   number of PUCCH F2/F3 resources to be generated.
/// \param[in] f0_f1_params    PUCCH F0/F1 resource parameters.
/// \param[in] f2_f3_params    PUCCH F2/F3 resource parameters.
/// \param[in] bwp_size_rbs    Size of the BWP in RBs.
/// \param[in] max_nof_symbols Maximum number of symbols.
/// \return The list of PUCCH resources for a cell. The list has the PUCCH Format 0/1 resources in front of the list,
/// and the PUCCH Format 2/3 in the back of the list.
...
///
/// This function generates the list of PUCCH F0/F1 and F2/F3 resources for a given UE, including the resources for
/// HARQ-ACK reporting, SR and CSI. It also updates the PUCCH resource sets accordingly, as well as the pointers to the
/// PUCCH F0/F1 resource for SR and to the PUCCH F2/F3 resource for CSI. This function overwrites the default \c
...
///   cell resources.
/// - \ref nof_ue_pucch_f2_f3_res_harq PUCCH Format 2/3 resources for HARQ-ACK reporting, chosen from
///   \ref nof_harq_pucch_sets possible sets of PUCCH Format 2/3 cell resources.
/// - 1 PUCCH Format 2/3 resource for CSI chosen from \ref nof_cell_pucch_f2_f3_res_csi possible sets of PUCCH Format
/// 2/3
///   cell resources.
///
/// The returned UE PUCCH resource list \ref pucch_res_list contains the following resources, sorted as follows:
///       [ F0/F1-HARQ_0 ... F0/F1-HARQ_N-1 F0/F1-SR F2/F3-HARQ_0 ... F2/F3-HARQ_M-1 F2/F3-CSI ]
/// where N = nof_ue_pucch_f0_f1_res_harq and M = nof_ue_pucch_f2_f3_res_harq,
...
/// - The next \ref nof_ue_pucch_f2_f3_res_harq are the PUCCH F2/F3 resources for HARQ-ACK and have index
///   [  nof_harq_pucch_sets * nof_ue_pucch_f0_f1_res_harq + nof_cell_pucch_f0_f1_res_sr +
///                     (du_harq_set_idx % nof_harq_pucch_sets) * nof_ue_pucch_f2_f3_res_harq,
///      nof_harq_pucch_sets * nof_ue_pucch_f0_f1_res_harq + nof_cell_pucch_f0_f1_res_sr +
///                     (du_harq_set_idx % nof_harq_pucch_sets) * nof_ue_pucch_f2_f3_res_harq +
///                     nof_ue_pucch_f2_f3_res_harq).
/// - The last resource in the list is the PUCCH F2/F3 resource for CSI, which has index:
////     nof_harq_pucch_sets * nof_ue_pucch_f0_f1_res_harq + nof_cell_pucch_f0_f1_res_sr +
///                     nof_ue_pucch_f2_f3_res_harq * nof_harq_pucch_sets + du_csi_res_idx %
...
/// \param[in] nof_cell_pucch_f2_f3_res_csi number of PUCCH F2/F3 resources for CSI available in the cell.
...
bool ue_pucch_config_builder(serving_cell_config&                                serv_cell_cfg,
                             ...
                             unsigned                                            nof_cell_pucch_f2_f3_res_csi = 1);
} // namespace srsran::srs_du
