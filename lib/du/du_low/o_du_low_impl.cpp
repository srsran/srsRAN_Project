...
fapi::slot_message_gateway& o_du_low_impl::get_slot_message_gateway(unsigned cell_id)
{
...
fapi::slot_last_message_notifier& o_du_low_impl::get_slot_last_message_notifier(unsigned cell_id)
{
  srsran_assert(cell_id < fapi_adaptors.size(),
                "Invalid cell index '{}'. Valid cell indexes [0-{})",
                cell_id,
...
void o_du_low_impl::set_slot_time_message_notifier(unsigned                          cell_id,
...
void o_du_low_impl::set_slot_error_message_notifier(unsigned                           cell_id,
...
void o_du_low_impl::set_slot_data_message_notifier(unsigned                          cell_id,
