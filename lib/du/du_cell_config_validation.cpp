...
check_outcome srs_du::is_du_cell_config_valid(const du_cell_config& cell_cfg)
{
  ...
  HANDLE_ERROR(config_helpers::pucch_parameters_validator(
      pucch_cfg.nof_ue_pucch_f0_or_f1_res_harq.to_uint() * pucch_cfg.nof_cell_res_set_configs +
          pucch_cfg.nof_cell_sr_resources,
      pucch_cfg.nof_ue_pucch_f2_or_f3_or_f4_res_harq.to_uint() * pucch_cfg.nof_cell_res_set_configs +
