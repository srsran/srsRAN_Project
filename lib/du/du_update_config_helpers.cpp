                                                               ...
                                                               bool                        is_long_prach)
{
  ...
  const std::vector<pucch_resource> res_list            = srs_du::generate_pucch_res_list_given_number(
      user_params.nof_ue_pucch_f1_res_harq.to_uint() + user_params.nof_sr_resources,
