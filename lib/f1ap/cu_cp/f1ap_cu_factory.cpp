...
std::unique_ptr<f1ap_cu> srsgnb::srs_cu_cp::create_f1ap(f1ap_message_notifier&       f1ap_pdu_notifier_,
                                                        ...
                                                        task_executor&               ctrl_exec_)
{
  auto f1ap_cu = std::make_unique<f1ap_cu_impl>(
      f1ap_pdu_notifier_, f1ap_du_processor_notifier_, f1ap_du_management_notifier_, ctrl_exec_);
  return f1ap_cu;
}
