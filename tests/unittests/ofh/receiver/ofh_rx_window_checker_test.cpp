...
TEST(ofh_rx_window_checker, on_time_packet_counts_one_packet)
{
  ...
  rx_window_checker rx_window(srslog::fetch_basic_logger("TEST"), {2, 9}, symbol_duration);
...
TEST(ofh_rx_window_checker, packet_on_the_window_end_count_as_valid)
{
  ...
  rx_window_checker rx_window(srslog::fetch_basic_logger("TEST"), {2, 15}, symbol_duration);
...
TEST(ofh_rx_window_checker, early_packet_counts_one_packet)
{
  ...
  rx_window_checker rx_window(srslog::fetch_basic_logger("TEST"), {3, 9}, symbol_duration);
