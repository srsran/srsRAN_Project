...
const std::array<uint8_t, pdu_size_snlen12> pdu1_count2049_snlen12   = {0x88, 0x01, 0xdf, 0xc8, 0x5c, 0xa6, 0x9b, 0x11};
...
const std::array<uint8_t, pdu_size_snlen12> pdu1_count4097_snlen12   = {0x80, 0x01, 0x1d, 0x2c, 0x66, 0xd3, 0xcb, 0xd1};
...
const std::array<uint8_t, pdu_size_snlen18> pdu1_count131073_snlen18 =
  ...
  if (sn_size == pdcp_sn_size::size12bits) {
    switch (count) {
      ...
      case 2048:
        ...
        return true;
      case 2049:
        exp_pdu = byte_buffer{pdu1_count2049_snlen12};
        return true;
      case 4095:
      ...
      case 4096:
        ...
        return true;
      case 4097:
        exp_pdu = byte_buffer{pdu1_count4097_snlen12};
        return true;
      case 262143:
    ...
    switch (count) {
      ...
      case 131072:
        ...
        return true;
      case 131073:
        exp_pdu = byte_buffer{pdu1_count131073_snlen18};
        return true;
      case 262143:
