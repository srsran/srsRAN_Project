...
public:
  ...
  void send_handover_request_and_await_bearer_context_setup_request()
  {
  ...
  void send_bearer_context_setup_response_and_await_ue_context_setup_request()
  {
  ...
  void send_bearer_context_modification_response_and_await_handover_request_ack()
  {
    ...
    report_fatal_error_if_not(result, "Failed to receive Handover Request Ack");
    report_fatal_error_if_not(test_helpers::is_valid_handover_request_ack(ngap_pdu), "Invalid Handover Request Ack");
  }

  void send_rrc_reconfiguration_complete_and_await_handover_notify()
  {
    ...
    bool result = this->wait_for_ngap_tx_pdu(ngap_pdu);
    report_fatal_error_if_not(result, "Failed to receive Handover Notify");
...
TEST_F(cu_cp_handover_test, when_handover_request_received_then_handover_notify_is_sent)
{
  ...
  send_handover_request_and_await_bearer_context_setup_request();

  // Inject Bearer Context Setup Response and await UE Context Setup Request
  send_bearer_context_setup_response_and_await_ue_context_setup_request();
  ...
  send_bearer_context_modification_response_and_await_handover_request_ack();
