...
TEST_F(task_execution_manager_test, worker_with_queues_of_different_priorities)
{
  ...
  priority_multiqueue_worker cfg{
      ...
      {priority_multiqueue_worker::executor{"EXEC1", task_priority::max, true, false, nullptr},
       priority_multiqueue_worker::executor{"EXEC2", task_priority::min, true, false, nullptr}}};
