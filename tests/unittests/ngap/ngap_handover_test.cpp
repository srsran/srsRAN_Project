...
TEST_F(ngap_test, when_source_gnb_handover_preperation_triggered_then_ho_command_received)
{
  ...
  async_task<cu_cp_ngap_handover_preparation_response>         t = ngap->handle_handover_preparation_request();
  lazy_task_launcher<cu_cp_ngap_handover_preparation_response> t_launcher(t);
}
