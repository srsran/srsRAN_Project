...
protected:
    ...
    params(cell_config_builder_profiles::tdd())
  {
    ...
    sched_cell_cfg_req.ded_pucch_resources = config_helpers::generate_cell_pucch_res_list(
        ...
        sched_cell_cfg_req.ul_cfg_common.init_ul_bwp.generic_params.crbs.length(),
