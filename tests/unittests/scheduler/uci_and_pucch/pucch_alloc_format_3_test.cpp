...
{
  auto& format_3                              = pucch_expected_f3.format_params.emplace<pucch_format_3>();
  ...
  format_3.max_code_rate     = max_pucch_code_rate::dot_25;
  format_3.group_hopping     = pucch_group_hopping::NEITHER;
  format_3.slot_repetition   = pucch_repetition_tx_slot::no_multi_slot;
  format_3.n_id_hopping      = t_bench.cell_cfg.pci;
  format_3.n_id_scrambling   = t_bench.cell_cfg.pci;
  format_3.n_id_0_scrambling = t_bench.cell_cfg.pci;
  format_3.pi_2_bpsk         = false;
...
{
  auto& format_3                               = pucch_expected_csi.format_params.emplace<pucch_format_3>();
...
TEST_F(test_pucch_allocator_format_3, test_csi_alloc_only)
{
  ...
  auto&                     format_3       = std::get<pucch_format_3>(pucch_expected_csi.format_params);
  format_3.harq_ack_nof_bits               = 0;
  format_3.sr_bits                         = sr_nof_bits::no_sr;
...
TEST_F(test_pucch_allocator_format_3, test_harq_alloc_3bits)
{
  ...
  ASSERT_EQ(pucch_res_idx, test_pucch_res_indicator.value());
  ASSERT_EQ(1, slot_grid.result.ul.pucchs.size());
  ASSERT_EQ(pucch_format::FORMAT_3, slot_grid.result.ul.pucchs[0].get_format());
...
{
  auto& format_3             = std::get<pucch_format_3>(pucch_expected_f3.format_params);
  format_3.harq_ack_nof_bits = 3;
  format_3.sr_bits           = sr_nof_bits::one;
  format_3.csi_part1_bits    = 0;
...
TEST_F(test_pucch_allocator_format_3, test_harq_alloc_1bit_over_csi)
{
  ...
  auto& format_3             = std::get<pucch_format_3>(pucch_expected_f3.format_params);
  format_3.harq_ack_nof_bits = 1;
  format_3.sr_bits           = sr_nof_bits::no_sr;
  format_3.csi_part1_bits    = 4;
...
TEST_F(test_pucch_allocator_format_3, test_harq_alloc_3bits_over_csi)
{
  ...
  auto& harq_format_3             = std::get<pucch_format_3>(pucch_expected_f3.format_params);
  harq_format_3.harq_ack_nof_bits = 3;
  harq_format_3.sr_bits           = sr_nof_bits::no_sr;
  harq_format_3.csi_part1_bits    = 0;

  auto& csi_format_3             = std::get<pucch_format_3>(pucch_expected_csi.format_params);
  csi_format_3.harq_ack_nof_bits = 0;
  csi_format_3.sr_bits           = sr_nof_bits::no_sr;
  csi_format_3.csi_part1_bits    = 4;

  pucch_info pucch_f3_harq_csi_mplexed = pucch_expected_f3;
  auto&      mplexed_format_3          = std::get<pucch_format_3>(pucch_f3_harq_csi_mplexed.format_params);
  mplexed_format_3.harq_ack_nof_bits   = 3;
  mplexed_format_3.sr_bits             = sr_nof_bits::no_sr;
  mplexed_format_3.csi_part1_bits      = 4;
...
TEST_F(test_pucch_allocator_format_3, test_harq_alloc_7bits_over_sr_and_csi)
{
  ...
  // spans over the 14 symbols.
  auto& format_3             = std::get<pucch_format_3>(pucch_expected_f3.format_params);
  format_3.harq_ack_nof_bits = nof_harq_bits;
  format_3.sr_bits           = sr_nof_bits::one;
  format_3.csi_part1_bits    = 4;
