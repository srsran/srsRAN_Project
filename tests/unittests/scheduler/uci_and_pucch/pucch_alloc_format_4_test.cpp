...
public:
    ...
    pucch_allocator_base_tester(test_bench_params{.pucch_res_common = 0, .set1_format = pucch_format::FORMAT_4})
  {
    ...
    pucch_expected_f4.format                    = pucch_format::FORMAT_4;
    ...
    pucch_expected_f4.format_4.max_code_rate     = max_pucch_code_rate::dot_25;
    pucch_expected_f4.format_4.group_hopping     = pucch_group_hopping::NEITHER;
    pucch_expected_f4.format_4.slot_repetition   = pucch_repetition_tx_slot::no_multi_slot;
    pucch_expected_f4.format_4.n_id_hopping      = t_bench.cell_cfg.pci;
    pucch_expected_f4.format_4.n_id_scrambling   = t_bench.cell_cfg.pci;
    pucch_expected_f4.format_4.n_id_0_scrambling = t_bench.cell_cfg.pci;
    pucch_expected_f4.format_4.pi_2_bpsk         = false;
    pucch_expected_f4.format_4.additional_dmrs   = false;
    pucch_expected_f4.format_4.orthog_seq_idx    = 0;
    pucch_expected_f4.format_4.n_sf_pucch_f4     = pucch_format_4_sf::sf2;

    // The expected resource for CSI corresponds to the last resource in the resource list.
    pucch_expected_csi.format                    = pucch_format::FORMAT_4;
    ...
    pucch_expected_csi.format_4.max_code_rate     = max_pucch_code_rate::dot_25;
    pucch_expected_csi.format_4.group_hopping     = pucch_group_hopping::NEITHER;
    pucch_expected_csi.format_4.slot_repetition   = pucch_repetition_tx_slot::no_multi_slot;
    pucch_expected_csi.format_4.n_id_hopping      = t_bench.cell_cfg.pci;
    pucch_expected_csi.format_4.n_id_scrambling   = t_bench.cell_cfg.pci;
    pucch_expected_csi.format_4.n_id_0_scrambling = t_bench.cell_cfg.pci;
    pucch_expected_csi.format_4.pi_2_bpsk         = false;
    pucch_expected_csi.format_4.additional_dmrs   = false;
    pucch_expected_csi.format_4.orthog_seq_idx    = 0;
    pucch_expected_csi.format_4.n_sf_pucch_f4     = pucch_format_4_sf::sf2;
  };
...
TEST_F(test_pucch_allocator_format_4, test_csi_alloc_only)
{
  ...
  pucch_expected_csi.format_4.harq_ack_nof_bits = 0;
  pucch_expected_csi.format_4.sr_bits           = sr_nof_bits::no_sr;
  pucch_expected_csi.format_4.csi_part1_bits    = csi_part1_bits;
...
TEST_F(test_pucch_allocator_format_4, test_csi_alloc_over_sr)
{
  static constexpr unsigned csi_part1_bits      = 4;
  pucch_expected_csi.format_4.harq_ack_nof_bits = 0;
  pucch_expected_csi.format_4.sr_bits           = sr_nof_bits::one;
  pucch_expected_csi.format_4.csi_part1_bits    = csi_part1_bits;
...
TEST_F(test_pucch_allocator_format_4, test_harq_alloc_3bits)
{
  ...
  ASSERT_EQ(3, slot_grid.result.ul.pucchs[0].format_4.harq_ack_nof_bits);
}

TEST_F(test_pucch_allocator_format_4, test_harq_alloc_3bits_over_sr)
{
  pucch_expected_f4.format_4.harq_ack_nof_bits = 3;
  pucch_expected_f4.format_4.sr_bits           = sr_nof_bits::one;
  pucch_expected_f4.format_4.csi_part1_bits    = 0;
...
TEST_F(test_pucch_allocator_format_4, test_harq_alloc_1bit_over_csi)
{
  ...
  pucch_expected_f4.format_4.harq_ack_nof_bits = 1;
  pucch_expected_f4.format_4.sr_bits           = sr_nof_bits::no_sr;
  pucch_expected_f4.format_4.csi_part1_bits    = 4;
...
TEST_F(test_pucch_allocator_format_4, test_harq_alloc_2bits_over_csi)
{
  ...
  // multiplexed into 1, which is the PUCCH HARQ resource from set 1 (Format 4).
  pucch_expected_f4.format_4.harq_ack_nof_bits = 2;
  pucch_expected_f4.format_4.sr_bits           = sr_nof_bits::no_sr;
  pucch_expected_f4.format_4.csi_part1_bits    = 4;
...
TEST_F(test_pucch_allocator_format_4, test_harq_alloc_3bits_over_csi)
{
  ...
  pucch_expected_csi.format_4.harq_ack_nof_bits = 0;
  pucch_expected_csi.format_4.sr_bits           = sr_nof_bits::no_sr;
  pucch_expected_csi.format_4.csi_part1_bits    = 4;

  pucch_info pucch_f4_harq_csi_mplexed                 = pucch_expected_f4;
  pucch_f4_harq_csi_mplexed.format_4.harq_ack_nof_bits = 3;
  pucch_f4_harq_csi_mplexed.format_4.sr_bits           = sr_nof_bits::no_sr;
  pucch_f4_harq_csi_mplexed.format_4.csi_part1_bits    = 4;
...
TEST_F(test_pucch_allocator_format_4, test_harq_alloc_20bits_over_sr_and_csi)
{
  ...
  // With SR and with PUCCH Format 1 it is guaranteed that the resources will be multiplexed, as PUCCH Format 1 for SR
  // spans over the 14 symbols.
  pucch_expected_f4.format_4.harq_ack_nof_bits = 20;
  pucch_expected_f4.format_4.sr_bits           = sr_nof_bits::one;
  pucch_expected_f4.format_4.csi_part1_bits    = 4;
