...
class PucchProcessorFormat2Fixture : public ::testing::TestWithParam<test_case_t>
{
protected:
...
std::unique_ptr<pucch_pdu_validator> PucchProcessorFormat2Fixture::pucch_validator;
