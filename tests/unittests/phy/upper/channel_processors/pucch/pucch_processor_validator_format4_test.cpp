...
// Maximum number of UCI payload bits supported by the current PUCCH Format 4 implementation.
constexpr unsigned PUCCH_F4_IMPL_MAX_NBITS = 1706;
...
class PucchProcessorFormat4Fixture : public ::testing::TestWithParam<test_case_t>
{
protected:
...
std::unique_ptr<pucch_processor>     PucchProcessorFormat4Fixture::pucch_proc;
std::unique_ptr<pucch_pdu_validator> PucchProcessorFormat4Fixture::pucch_validator;
