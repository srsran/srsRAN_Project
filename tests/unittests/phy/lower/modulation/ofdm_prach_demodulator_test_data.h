...
// This file was generated using the following MATLAB class on 01-08-2024 (seed 0):
...
static const std::vector<test_case_t> ofdm_prach_demodulator_test_data = {
  ...
  {{sampling_rate::from_MHz(30.72), {{0, 4}, to_prach_format_type("B4"), 1, 2, 0, 10, 79}}, {"test_data/ofdm_prach_demodulator_test_input3.dat"}, {"test_data/ofdm_prach_demodulator_test_output3.dat"}},
  ...
  {{sampling_rate::from_MHz(30.72), {{0, 4}, to_prach_format_type("B1"), 7, 2, 0, 10, 106}}, {"test_data/ofdm_prach_demodulator_test_input7.dat"}, {"test_data/ofdm_prach_demodulator_test_output7.dat"}},
  ...
  {{sampling_rate::from_MHz(61.44), {{0, 14}, to_prach_format_type("C2"), 2, 2, 0, 10, 212}}, {"test_data/ofdm_prach_demodulator_test_input11.dat"}, {"test_data/ofdm_prach_demodulator_test_output11.dat"}},
  ...
  {{sampling_rate::from_MHz(61.44), {{0, 2}, to_prach_format_type("2"), 1, 2, 0, 10, 275}}, {"test_data/ofdm_prach_demodulator_test_input15.dat"}, {"test_data/ofdm_prach_demodulator_test_output15.dat"}},
  ...
  {{sampling_rate::from_MHz(61.44), {{1, 39}, to_prach_format_type("A2"), 3, 2, 0, 10, 79}}, {"test_data/ofdm_prach_demodulator_test_input19.dat"}, {"test_data/ofdm_prach_demodulator_test_output19.dat"}},
  ...
  {{sampling_rate::from_MHz(61.44), {{1, 5}, to_prach_format_type("1"), 1, 2, 0, 10, 106}}, {"test_data/ofdm_prach_demodulator_test_input23.dat"}, {"test_data/ofdm_prach_demodulator_test_output23.dat"}},
  ...
  {{sampling_rate::from_MHz(122.88), {{1, 39}, to_prach_format_type("A3/B3"), 2, 2, 0, 10, 212}}, {"test_data/ofdm_prach_demodulator_test_input27.dat"}, {"test_data/ofdm_prach_demodulator_test_output27.dat"}},
  ...
  {{sampling_rate::from_MHz(122.88), {{1, 19}, to_prach_format_type("3"), 1, 2, 0, 10, 275}}, {"test_data/ofdm_prach_demodulator_test_input31.dat"}, {"test_data/ofdm_prach_demodulator_test_output31.dat"}},
  ...
  {{sampling_rate::from_MHz(245.76), {{3, 89}, to_prach_format_type("C2"), 2, 2, 0, 10, 79}}, {"test_data/ofdm_prach_demodulator_test_input35.dat"}, {"test_data/ofdm_prach_demodulator_test_output35.dat"}},
  ...
  {{sampling_rate::from_MHz(245.76), {{3, 89}, to_prach_format_type("C2"), 2, 2, 0, 10, 106}}, {"test_data/ofdm_prach_demodulator_test_input39.dat"}, {"test_data/ofdm_prach_demodulator_test_output39.dat"}},
  ...
  {{sampling_rate::from_MHz(491.52), {{3, 89}, to_prach_format_type("A1"), 6, 2, 0, 10, 212}}, {"test_data/ofdm_prach_demodulator_test_input43.dat"}, {"test_data/ofdm_prach_demodulator_test_output43.dat"}},
  ...
  {{sampling_rate::from_MHz(491.52), {{3, 89}, to_prach_format_type("A3"), 2, 2, 0, 10, 275}}, {"test_data/ofdm_prach_demodulator_test_input47.dat"}, {"test_data/ofdm_prach_demodulator_test_output47.dat"}},
    // clang-format on
};
