...
class split_7_2_du_factory : public flexible_du_factory
{
  const split_7_2_du_unit_config& unit_config;
...
class multicell_split_7_2_du_factory : public multicell_flexible_du_factory
{
  const split_7_2_du_unit_config& unit_config;

public:
  explicit multicell_split_7_2_du_factory(const split_7_2_du_unit_config& config_) :
