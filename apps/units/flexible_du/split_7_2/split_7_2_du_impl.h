...
/// DU split 7.2 implementation.
class split_7_2_du_impl : public srs_du::du, public du_power_controller
{
public:
  explicit split_7_2_du_impl(unsigned nof_cells);
  ...
  /// Adds the given RU to this split 7.2 DU.
  void add_ru(std::unique_ptr<radio_unit> active_ru);

  /// Adds the given DUs to this split 7.2 DU.
