...
split_7_2_du_impl::split_7_2_du_impl(unsigned nof_cells) :
  ru_ul_adapt(nof_cells), ru_timing_adapt(nof_cells), ru_error_adapt(nof_cells)
{
}

void split_7_2_du_impl::start()
{
...
void split_7_2_du_impl::add_ru(std::unique_ptr<radio_unit> active_ru)
{
...
void split_7_2_du_impl::add_dus(std::vector<std::unique_ptr<srs_du::du_wrapper>> active_du)
{
