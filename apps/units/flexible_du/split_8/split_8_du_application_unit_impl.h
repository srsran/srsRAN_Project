...
/// Split 8 DU application unit implementation.
class split_8_du_application_unit_impl : public flexible_du_application_unit
{
public:
  explicit split_8_du_application_unit_impl(std::string_view app_name);
...
private:
  split_8_du_unit_config unit_cfg;
};
