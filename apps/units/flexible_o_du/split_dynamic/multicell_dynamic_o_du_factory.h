...
/// Multicell dynamic O-RAN DU factory.
class multicell_dynamic_o_du_factory : public multicell_flexible_o_du_factory
{
  const dynamic_o_du_unit_config& unit_config;

public:
  explicit multicell_dynamic_o_du_factory(const dynamic_o_du_unit_config& config_) :
