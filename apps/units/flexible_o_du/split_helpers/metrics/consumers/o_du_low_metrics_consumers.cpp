...
void o_du_low_metrics_consumer_json::handle_metric(const srs_du::o_du_low_metrics& metric)
{
  ...
  for (const auto& upper_metrics : metric.du_lo_metrics.sector_metrics) {
    ...
    // L1 DL processing.
    double dmrs_cpu_usage = 100.0 * upper_metrics.pdsch_metrics.dmrs_metrics.cpu_usage_us / metric_period_us;
...
void o_du_low_metrics_consumer_log::handle_metric(const srs_du::o_du_low_metrics& metric)
{
  ...
  for (const auto& upper_metrics : metric.du_lo_metrics.sector_metrics) {
    ...
    fmt::format_to(std::back_inserter(buffer),
                   ...
                   upper_metrics.ldpc_metrics.encoder_metrics.avg_cb_latency_us,
                   upper_metrics.ldpc_metrics.encoder_metrics.max_cb_latency_us,
                   upper_metrics.ldpc_metrics.decoder_metrics.avg_cb_latency_us,
                   upper_metrics.ldpc_metrics.decoder_metrics.max_cb_latency_us,
                   upper_metrics.ldpc_metrics.decoder_metrics.avg_nof_iterations);
