...
#include "multicell_flexible_o_du_factory.h"
...
o_du_unit multicell_flexible_o_du_factory::create_flexible_o_du(const o_du_unit_dependencies& dependencies)
{
  o_du_unit      o_du;
  ...
  auto du_impl = std::make_unique<multicell_flexible_o_du_impl>(nof_cells);
