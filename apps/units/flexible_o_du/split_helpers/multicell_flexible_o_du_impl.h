...
/// \brief Multicell flexible O-RAN DU implementation.
///
/// One O-RAN DU can handle more than one cell.
class multicell_flexible_o_du_impl : public srs_du::du, public du_power_controller
{
public:
  explicit multicell_flexible_o_du_impl(unsigned nof_cells);
