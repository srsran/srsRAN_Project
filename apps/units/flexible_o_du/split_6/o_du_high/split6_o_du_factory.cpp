                                     ...
                                     std::unique_ptr<fapi_adaptor::phy_fapi_adaptor> fapi_adaptor)
{
  ...
  for (unsigned i = 0, e = du_hi_unit_cfg.cells_cfg.size(); i != e; ++i) {
    ...
    sector_dependencies.gateway           = &p7_sector_adaptor.get_slot_message_gateway();
    sector_dependencies.last_msg_notifier = &p7_sector_adaptor.get_slot_last_message_notifier();
