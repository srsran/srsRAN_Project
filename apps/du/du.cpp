...
int main(int argc, char** argv)
{
  ...
  du_f1u_gw_config.bind_address                 = du_cfg.f1u_cfg.f1u_sockets.f1u_socket_cfg[0].bind_addr;
  du_f1u_gw_config.bind_port                    = GTPU_PORT;
  du_f1u_gw_config.reuse_addr                   = false;
  du_f1u_gw_config.pool_occupancy_threshold = du_cfg.f1u_cfg.f1u_sockets.f1u_socket_cfg[0].udp_config.pool_threshold;
  ...
  std::unique_ptr<srs_du::f1u_du_udp_gateway> du_f1u_conn =
      srs_du::create_split_f1u_gw({du_f1u_gw.get(),
                                   du_f1u_gtpu_demux.get(),
                                   *du_pcaps.f1u,
                                   GTPU_PORT,
                                   du_cfg.f1u_cfg.f1u_sockets.f1u_socket_cfg[0].udp_config.ext_addr});
