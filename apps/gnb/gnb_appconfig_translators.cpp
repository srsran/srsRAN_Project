...
srs_cu_cp::cu_cp_configuration srsran::generate_cu_cp_config(const du_high_unit_config& config,
...
e2ap_configuration srsran::generate_e2_config(const gnb_appconfig& config, const du_high_unit_config& du_high)
{
