...
gnb_console_helper::gnb_console_helper(io_broker& io_broker_, srslog::log_channel& log_c_) :
  logger(srslog::fetch_basic_logger("GNB")), io_broker_handle(io_broker_), metrics_json(log_c_)
{
