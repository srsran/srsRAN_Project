...
int main(int argc, char** argv)
{
  ...
  for (const f1u_socket_appconfig& sock_cfg : cu_cfg.f1u_cfg.f1u_socket_cfg) {
    ...
    cu_f1u_gw_config.bind_port                  = cu_cfg.f1u_cfg.f1u_port;
  ...
  std::unique_ptr<f1u_cu_up_udp_gateway> cu_f1u_conn =
      srs_cu_up::create_split_f1u_gw({f1u_gw_maps, *cu_f1u_gtpu_demux, *cu_up_dlt_pcaps.f1u, cu_cfg.f1u_cfg.f1u_port});
